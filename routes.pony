...
actor Routes
    ...
    be get_application_role_connection_metadata(application_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/applications/" + application_id.string() + "/role-connections/metadata"), handler)

    be update_application_role_connection_metadata(application_id: Snowflake, application_role_connection_metadata: Array[ApplicationRoleConnectionMetadata] val, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.PUT, "/applications/" + application_id.string() + "/role-connections/metadata" where body = json.JsonPrinter.print(records)), handler)

    be get_application(handler: ResponseReceiver) =>
        """
    ...
    be get_audit_log(guild_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/audit-logs" where query = params.to_query()), handler)

    be get_auto_moderation_rules(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/auto-moderation/rules"), handler)

    be get_auto_moderation_rule(guild_id: Snowflake, auto_moderation_rule_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be delete_auto_moderation_rule(guild_id: Snowflake, auto_moderation_rule_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/guilds/" + guild_id.string() + "/auto-moderation/rules/" + auto_moderation_rule_id.string() where reason = reason), handler)

    be get_channel(channel_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be join_thread(channel_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.PUT, "/channels/" + channel_id.string() + "/thread-members/@me"), handler)

    be add_thread_member(channel_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.PUT, "/channels/" + channel_id.string() + "/thread-members/" + user_id.string()), handler)

    be leave_thread(channel_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/channels/" + channel_id.string() + "/thread-members/@me"), handler)

    be remove_thread_member(channel_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_joined_private_archived_threads(channel_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/users/@me/threads/archived/private" where query = params.to_query()), handler)

    be get_guild_emojis(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/emojis"), handler)

    be get_guild_emoji(guild_id: Snowflake, emoji_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be delete_guild_emoji(guild_id: Snowflake, emoji_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/guilds/" + guild_id.string() + "/emojis/" + emoji_id.string() where reason = reason), handler)

    be get_application_emojis(application_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/applications/" + application_id.string() + "/emojis"), handler)

    be get_application_emoji(application_id: Snowflake, emoji_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_entitlements(application_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/applications/" + application_id.string() + "/entitlements" where query = params.to_query()), handler)

    be get_entitlement(application_id: Snowflake, entitlement_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/applications/" + application_id.string() + "/entitlements/" + entitlement_id.string()), handler)

    be consume_entitlement(application_id: Snowflake, entitlement_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild(guild_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() where query = params.to_query()), handler)

    be get_guild_preview(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_active_guild_threads(guild_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/threads/active"), handler)

    be get_guild_member(guild_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be add_guild_member_role(guild_id: Snowflake, user_id: Snowflake, role_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        ...
        api.send_request(options.build_request(courier.PUT, "/guilds/" + guild_id.string() + "/members/" + user_id.string() + "/roles/" + role_id.string() where reason = reason), handler)

    be remove_guild_member_role(guild_id: Snowflake, user_id: Snowflake, role_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/guilds/" + guild_id.string() + "/members/" + user_id.string() + "/roles/" + role_id.string() where reason = reason), handler)

    be remove_guild_member(guild_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        """
    ...
    be get_guild_bans(guild_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/bans" where query = params.to_query()), handler)

    be get_guild_ban(guild_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_roles(guild_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/roles"), handler)

    be get_guild_role(guild_id: Snowflake, role_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/roles/" + role_id.string()), handler)

    be get_guild_role_member_counts(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_voice_regions(guild_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/regions"), handler)

    be get_guild_invites(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/invites"), handler)

    be get_guild_integrations(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/integrations"), handler)

    be delete_guild_integration(guild_id: Snowflake, integration_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/guilds/" + guild_id.string() + "/integrations/" + integration_id.string() where reason = reason), handler)

    be get_guild_widget_settings(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_widget(guild_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/widget.json"), handler)

    be get_guild_vanity_url(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_widget_image(guild_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/widget.png" where query = params.to_query()), handler)

    be get_guild_welcome_screen(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_scheduled_event_users(guild_id: Snowflake, guild_scheduled_event_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/scheduled-events/" + guild_scheduled_event_id.string() + "/users" where query = params.to_query()), handler)

    be get_guild_template(template_code: String, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/templates/" + template_code), handler)

    be get_guild_templates(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_invite(invite_code: String, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/invites/" + invite_code where query = params.to_query()), handler)

    be delete_invite(invite_code: String, handler: ResponseReceiver, reason: Reason = None) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/invites/" + invite_code where reason = reason), handler)

    be get_invite_target_users(invite_code: String, handler: ResponseReceiver) =>
        """
    ...
    be remove_lobby_member(lobby_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/lobbies/" + lobby_id.string() + "/members/" + user_id.string()), handler)

    be leave_lobby(lobby_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be create_lobby_channel_invite_for_self(lobby_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.POST, "/lobbies/" + lobby_id.string() + "/members/@me/invites"), handler)

    be create_lobby_channel_invite_for_user(lobby_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be search_guild_messages(guild_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/messages/search" where query = params.to_query()), handler)

    be get_channel_message(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be crosspost_message(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.POST, "/channels/" + channel_id.string() + "/messages/" + message_id.string() + "/crosspost"), handler)

    be create_reaction(channel_id: Snowflake, message_id: Snowflake, emoji: String, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.PUT, "/channels/" + channel_id.string() + "/messages/" + message_id.string() + "/reactions/" + emoji + "/@me"), handler)

    be delete_own_reaction(channel_id: Snowflake, message_id: Snowflake, emoji: String, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/channels/" + channel_id.string() + "/messages/" + message_id.string() + "/reactions/" + emoji + "/@me"), handler)

    be delete_user_reaction(channel_id: Snowflake, message_id: Snowflake, emoji: String, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_reactions(channel_id: Snowflake, message_id: Snowflake, emoji: String, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/messages/" + message_id.string() + "/reactions/" + emoji where query = params.to_query()), handler)

    be delete_all_reactions(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/channels/" + channel_id.string() + "/messages/" + message_id.string() + "/reactions"), handler)

    be delete_all_reactions_for_emoji(channel_id: Snowflake, message_id: Snowflake, emoji: String, handler: ResponseReceiver) =>
        """
    ...
    be get_channel_pins(channel_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/messages/pins" where query = params.to_query()), handler)

    be pin_message(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        """
        ...
        api.send_request(options.build_request(courier.PUT, "/channels/" + channel_id.string() + "/messages/pins/" + message_id.string() where reason = reason), handler)

    be unpin_message(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        """
        ...
        api.send_request(options.build_request(courier.DELETE, "/channels/" + channel_id.string() + "/messages/pins/" + message_id.string() where reason = reason), handler)

    be get_pinned_messages_deprecated(channel_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/pins"), handler)

    be pin_message_deprecated(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.PUT, "/channels/" + channel_id.string() + "/pins/" + message_id.string()), handler)

    be unpin_message_deprecated(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_answer_voters(channel_id: Snowflake, message_id: Snowflake, answer_id: U64, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/polls/" + message_id.string() + "/answers/" + answer_id.string() where query = params.to_query()), handler)

    be end_poll(channel_id: Snowflake, message_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.POST, "/channels/" + channel_id.string() + "/polls/" + message_id.string() + "/expire"), handler)

    be get_skus(application_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_default_soundboard_sounds(handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/soundboard-default-sounds"), handler)

    be get_guild_soundboard_sounds(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/soundboard-sounds"), handler)

    be get_guild_soundboard_sound(guild_id: Snowflake, sound_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be delete_stage_instance(channel_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/stage-instances/" + channel_id.string() where reason = reason), handler)

    be get_sticker(sticker_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/stickers/" + sticker_id.string()), handler)

    be get_sticker_packs(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/sticker-packs"), handler)

    be get_sticker_pack(sticker_pack_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/sticker-packs/" + sticker_pack_id.string()), handler)

    be get_guild_stickers(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/stickers"), handler)

    be get_guild_sticker(guild_id: Snowflake, sticker_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_sku_subscriptions(sku_id: Snowflake, params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/skus/" + sku_id.string() + "/subscriptions" where query = params.to_query()), handler)

    be get_sku_subscription(sku_id: Snowflake, subscription_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/skus/" + sku_id.string() + "/subscriptions/" + subscription_id.string()), handler)

    be get_current_user(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/users/@me"), handler)

    be get_user(user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_current_user_guilds(params: ParamsStub, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/users/@me/guilds" where query = params.to_query()), handler)

    be get_current_user_guild_member(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/users/@me/guilds/" + guild_id.string() + "/member"), handler)

    be leave_guild(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_current_user_connections(handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/users/@me/connections"), handler)

    be get_current_user_application_role_connection(application_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be delete_current_user_application_role_connection(application_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/users/@me/applications/" + application_id.string() + "/role-connection"), handler)

    be get_voice_regions(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/voice/regions"), handler)

    be get_current_user_voice_state(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/voice-states/@me"), handler)

    be get_user_voice_state(guild_id: Snowflake, user_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_channel_webhooks(channel_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/channels/" + channel_id.string() + "/webhooks"), handler)

    be get_guild_webhooks(guild_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/guilds/" + guild_id.string() + "/webhooks"), handler)

    be get_webhook(webhook_id: Snowflake, handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/webhooks/" + webhook_id.string()), handler)

    be get_webhook_with_token(webhook_id: Snowflake, webhook_token: String, handler: ResponseReceiver) =>
        """
    ...
    be delete_webhook(webhook_id: Snowflake, handler: ResponseReceiver, reason: Reason = None) =>
        ...
        api.send_request(options.build_request(courier.DELETE, "/webhooks/" + webhook_id.string() where reason = reason), handler)

    be delete_webhook_with_token(webhook_id: Snowflake, webhook_token: String, handler: ResponseReceiver) =>
        """
    ...
    be get_guild_application_command_permissions(application_id: Snowflake, guild_id: Snowflake, handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/applications/" + application_id.string() + "/guilds/" + guild_id.string() + "/commands/permissions"), handler)

    be get_application_command_permissions(application_id: Snowflake, guild_id: Snowflake, command_id: Snowflake, handler: ResponseReceiver) =>
        """
    ...
    be get_current_bot_application_information(handler: ResponseReceiver) =>
        ...
        api.send_request(options.build_request(courier.GET, "/oauth2/applications/@me"), handler)

    be get_current_authorization_information(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/oauth2/@me"), handler)

    be get_gateway(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/gateway"), handler)

    be get_gateway_bot(handler: ResponseReceiver) =>
        """
        ...
        api.send_request(options.build_request(courier.GET, "/gateway/bot"), handler)