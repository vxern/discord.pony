...
actor Events
    ...
    embed _rate_limited: _Listeners[GatewayRateLimited] = _Listeners[GatewayRateLimited]
    embed _application_command_permissions_update: _Listeners[GuildApplicationCommandPermissions] = _Listeners[GuildApplicationCommandPermissions]
    embed _auto_moderation_rule_create: _Listeners[AutoModerationRule] = _Listeners[AutoModerationRule]
    embed _auto_moderation_rule_update: _Listeners[AutoModerationRule] = _Listeners[AutoModerationRule]
    embed _auto_moderation_rule_delete: _Listeners[AutoModerationRule] = _Listeners[AutoModerationRule]
    embed _auto_moderation_action_execution: _Listeners[AutoModerationActionExecution] = _Listeners[AutoModerationActionExecution]
    ...
    embed _channel_pins_update: _Listeners[ChannelPinsUpdate] = _Listeners[ChannelPinsUpdate]
    ...
    embed _thread_list_sync: _Listeners[ThreadListSync] = _Listeners[ThreadListSync]
    embed _thread_member_update: _Listeners[ThreadMemberUpdate] = _Listeners[ThreadMemberUpdate]
    embed _thread_members_update: _Listeners[ThreadMembersUpdate] = _Listeners[ThreadMembersUpdate]
    ...
    embed _guild_create: _Listeners[(GuildCreate | UnavailableGuild)] = _Listeners[(GuildCreate | UnavailableGuild)]
    embed _guild_update: _Listeners[Guild] = _Listeners[Guild]
    embed _guild_delete: _Listeners[UnavailableGuild] = _Listeners[UnavailableGuild]
    embed _guild_audit_log_entry_create: _Listeners[GuildAuditLogEntryCreate] = _Listeners[GuildAuditLogEntryCreate]
    embed _guild_ban_add: _Listeners[GuildBanAdd] = _Listeners[GuildBanAdd]
    embed _guild_ban_remove: _Listeners[GuildBanRemove] = _Listeners[GuildBanRemove]
    embed _guild_emojis_update: _Listeners[GuildEmojisUpdate] = _Listeners[GuildEmojisUpdate]
    embed _guild_stickers_update: _Listeners[GuildStickersUpdate] = _Listeners[GuildStickersUpdate]
    embed _guild_integrations_update: _Listeners[GuildIntegrationsUpdate] = _Listeners[GuildIntegrationsUpdate]
    embed _guild_member_add: _Listeners[GuildMemberAdd] = _Listeners[GuildMemberAdd]
    embed _guild_member_remove: _Listeners[GuildMemberRemove] = _Listeners[GuildMemberRemove]
    embed _guild_member_update: _Listeners[GuildMemberUpdate] = _Listeners[GuildMemberUpdate]
    embed _guild_members_chunk: _Listeners[GuildMembersChunk] = _Listeners[GuildMembersChunk]
    embed _guild_role_create: _Listeners[GuildRoleCreate] = _Listeners[GuildRoleCreate]
    embed _guild_role_update: _Listeners[GuildRoleUpdate] = _Listeners[GuildRoleUpdate]
    embed _guild_role_delete: _Listeners[GuildRoleDelete] = _Listeners[GuildRoleDelete]
    embed _guild_scheduled_event_create: _Listeners[GuildScheduledEvent] = _Listeners[GuildScheduledEvent]
    embed _guild_scheduled_event_update: _Listeners[GuildScheduledEvent] = _Listeners[GuildScheduledEvent]
    embed _guild_scheduled_event_delete: _Listeners[GuildScheduledEvent] = _Listeners[GuildScheduledEvent]
    embed _guild_scheduled_event_user_add: _Listeners[GuildScheduledEventUserAdd] = _Listeners[GuildScheduledEventUserAdd]
    embed _guild_scheduled_event_user_remove: _Listeners[GuildScheduledEventUserRemove] = _Listeners[GuildScheduledEventUserRemove]
    embed _guild_soundboard_sound_create: _Listeners[SoundboardSound] = _Listeners[SoundboardSound]
    embed _guild_soundboard_sound_update: _Listeners[SoundboardSound] = _Listeners[SoundboardSound]
    embed _guild_soundboard_sound_delete: _Listeners[GuildSoundboardSoundDelete] = _Listeners[GuildSoundboardSoundDelete]
    embed _guild_soundboard_sounds_update: _Listeners[GuildSoundboardSoundsUpdate] = _Listeners[GuildSoundboardSoundsUpdate]
    embed _soundboard_sounds: _Listeners[SoundboardSounds] = _Listeners[SoundboardSounds]
    embed _integration_create: _Listeners[IntegrationCreate] = _Listeners[IntegrationCreate]
    embed _integration_update: _Listeners[IntegrationUpdate] = _Listeners[IntegrationUpdate]
    embed _integration_delete: _Listeners[IntegrationDelete] = _Listeners[IntegrationDelete]
    ...
    embed _message_delete_bulk: _Listeners[MessageDeleteBulk] = _Listeners[MessageDeleteBulk]
    embed _message_reaction_add: _Listeners[MessageReactionAdd] = _Listeners[MessageReactionAdd]
    embed _message_reaction_remove: _Listeners[MessageReactionRemove] = _Listeners[MessageReactionRemove]
    embed _message_reaction_remove_all: _Listeners[MessageReactionRemoveAll] = _Listeners[MessageReactionRemoveAll]
    embed _message_reaction_remove_emoji: _Listeners[MessageReactionRemoveEmoji] = _Listeners[MessageReactionRemoveEmoji]
    embed _message_poll_vote_add: _Listeners[MessagePollVoteAdd] = _Listeners[MessagePollVoteAdd]
    embed _message_poll_vote_remove: _Listeners[MessagePollVoteRemove] = _Listeners[MessagePollVoteRemove]
    embed _presence_update: _Listeners[Presence] = _Listeners[Presence]
    embed _stage_instance_create: _Listeners[StageInstance] = _Listeners[StageInstance]
    embed _stage_instance_update: _Listeners[StageInstance] = _Listeners[StageInstance]
    embed _stage_instance_delete: _Listeners[StageInstance] = _Listeners[StageInstance]
    embed _subscription_create: _Listeners[Subscription] = _Listeners[Subscription]
    embed _subscription_update: _Listeners[Subscription] = _Listeners[Subscription]
    embed _subscription_delete: _Listeners[Subscription] = _Listeners[Subscription]
    embed _typing_start: _Listeners[TypingStart] = _Listeners[TypingStart]
    embed _user_update: _Listeners[User] = _Listeners[User]
    embed _voice_channel_effect_send: _Listeners[VoiceChannelEffectSend] = _Listeners[VoiceChannelEffectSend]
    embed _voice_channel_status_update: _Listeners[VoiceChannelStatusUpdate] = _Listeners[VoiceChannelStatusUpdate]
    embed _voice_channel_start_time_update: _Listeners[VoiceChannelStartTimeUpdate] = _Listeners[VoiceChannelStartTimeUpdate]
    ...
    be on_application_command_permissions_update(handler: GatewayEventHandler[GuildApplicationCommandPermissions]) =>
        _application_command_permissions_update.add(handler)

    be on_auto_moderation_rule_create(handler: GatewayEventHandler[AutoModerationRule]) =>
        _auto_moderation_rule_create.add(handler)

    be on_auto_moderation_rule_update(handler: GatewayEventHandler[AutoModerationRule]) =>
        _auto_moderation_rule_update.add(handler)

    be on_auto_moderation_rule_delete(handler: GatewayEventHandler[AutoModerationRule]) =>
        _auto_moderation_rule_delete.add(handler)

    be on_auto_moderation_action_execution(handler: GatewayEventHandler[AutoModerationActionExecution]) =>
    ...
    be on_channel_pins_update(handler: GatewayEventHandler[ChannelPinsUpdate]) =>
    ...
    be on_thread_member_update(handler: GatewayEventHandler[ThreadMemberUpdate]) =>
        _thread_member_update.add(handler)

    be on_thread_members_update(handler: GatewayEventHandler[ThreadMembersUpdate]) =>
    ...
    be on_guild_create(handler: GatewayEventHandler[(GuildCreate | UnavailableGuild)]) =>
    ...
    be on_guild_audit_log_entry_create(handler: GatewayEventHandler[GuildAuditLogEntryCreate]) =>
    ...
    be on_guild_emojis_update(handler: GatewayEventHandler[GuildEmojisUpdate]) =>
        _guild_emojis_update.add(handler)

    be on_guild_stickers_update(handler: GatewayEventHandler[GuildStickersUpdate]) =>
        _guild_stickers_update.add(handler)

    be on_guild_integrations_update(handler: GatewayEventHandler[GuildIntegrationsUpdate]) =>
    ...
    be on_guild_member_remove(handler: GatewayEventHandler[GuildMemberRemove]) =>
        _guild_member_remove.add(handler)

    be on_guild_member_update(handler: GatewayEventHandler[GuildMemberUpdate]) =>
        _guild_member_update.add(handler)

    be on_guild_members_chunk(handler: GatewayEventHandler[GuildMembersChunk]) =>
    ...
    be on_guild_scheduled_event_create(handler: GatewayEventHandler[GuildScheduledEvent]) =>
        _guild_scheduled_event_create.add(handler)

    be on_guild_scheduled_event_update(handler: GatewayEventHandler[GuildScheduledEvent]) =>
        _guild_scheduled_event_update.add(handler)

    be on_guild_scheduled_event_delete(handler: GatewayEventHandler[GuildScheduledEvent]) =>
        _guild_scheduled_event_delete.add(handler)

    be on_guild_scheduled_event_user_add(handler: GatewayEventHandler[GuildScheduledEventUserAdd]) =>
        _guild_scheduled_event_user_add.add(handler)

    be on_guild_scheduled_event_user_remove(handler: GatewayEventHandler[GuildScheduledEventUserRemove]) =>
        _guild_scheduled_event_user_remove.add(handler)

    be on_guild_soundboard_sound_create(handler: GatewayEventHandler[SoundboardSound]) =>
        _guild_soundboard_sound_create.add(handler)

    be on_guild_soundboard_sound_update(handler: GatewayEventHandler[SoundboardSound]) =>
        _guild_soundboard_sound_update.add(handler)

    be on_guild_soundboard_sound_delete(handler: GatewayEventHandler[GuildSoundboardSoundDelete]) =>
        _guild_soundboard_sound_delete.add(handler)

    be on_guild_soundboard_sounds_update(handler: GatewayEventHandler[GuildSoundboardSoundsUpdate]) =>
    ...
    be on_message_delete_bulk(handler: GatewayEventHandler[MessageDeleteBulk]) =>
        _message_delete_bulk.add(handler)

    be on_message_reaction_add(handler: GatewayEventHandler[MessageReactionAdd]) =>
        _message_reaction_add.add(handler)

    be on_message_reaction_remove(handler: GatewayEventHandler[MessageReactionRemove]) =>
        _message_reaction_remove.add(handler)

    be on_message_reaction_remove_all(handler: GatewayEventHandler[MessageReactionRemoveAll]) =>
        _message_reaction_remove_all.add(handler)

    be on_message_reaction_remove_emoji(handler: GatewayEventHandler[MessageReactionRemoveEmoji]) =>
        _message_reaction_remove_emoji.add(handler)

    be on_message_poll_vote_add(handler: GatewayEventHandler[MessagePollVoteAdd]) =>
        _message_poll_vote_add.add(handler)

    be on_message_poll_vote_remove(handler: GatewayEventHandler[MessagePollVoteRemove]) =>
    ...
    be on_voice_channel_effect_send(handler: GatewayEventHandler[VoiceChannelEffectSend]) =>
        _voice_channel_effect_send.add(handler)

    be on_voice_channel_status_update(handler: GatewayEventHandler[VoiceChannelStatusUpdate]) =>
        _voice_channel_status_update.add(handler)

    be on_voice_channel_start_time_update(handler: GatewayEventHandler[VoiceChannelStartTimeUpdate]) =>
    ...
    be on_voice_server_update(handler: GatewayEventHandler[VoiceServerUpdate]) =>
    ...
    be _dispatch(name: String, data: GatewayDispatchEventData) =>
        ...
        try
            ...
            | "APPLICATION_COMMAND_PERMISSIONS_UPDATE" => _application_command_permissions_update(data as GuildApplicationCommandPermissions)
            | "AUTO_MODERATION_RULE_CREATE" => _auto_moderation_rule_create(data as AutoModerationRule)
            | "AUTO_MODERATION_RULE_UPDATE" => _auto_moderation_rule_update(data as AutoModerationRule)
            | "AUTO_MODERATION_RULE_DELETE" => _auto_moderation_rule_delete(data as AutoModerationRule)
            | "AUTO_MODERATION_ACTION_EXECUTION" => _auto_moderation_action_execution(data as AutoModerationActionExecution)
            ...
            | "CHANNEL_PINS_UPDATE" => _channel_pins_update(data as ChannelPinsUpdate)
            ...
            | "THREAD_MEMBER_UPDATE" => _thread_member_update(data as ThreadMemberUpdate)
            | "THREAD_MEMBERS_UPDATE" => _thread_members_update(data as ThreadMembersUpdate)
            ...
            | "GUILD_CREATE" => _guild_create(data as (GuildCreate | UnavailableGuild))
            | "GUILD_UPDATE" => _guild_update(data as Guild)
            | "GUILD_DELETE" => _guild_delete(data as UnavailableGuild)
            | "GUILD_AUDIT_LOG_ENTRY_CREATE" => _guild_audit_log_entry_create(data as GuildAuditLogEntryCreate)
            | "GUILD_BAN_ADD" => _guild_ban_add(data as GuildBanAdd)
            | "GUILD_BAN_REMOVE" => _guild_ban_remove(data as GuildBanRemove)
            | "GUILD_EMOJIS_UPDATE" => _guild_emojis_update(data as GuildEmojisUpdate)
            | "GUILD_STICKERS_UPDATE" => _guild_stickers_update(data as GuildStickersUpdate)
            | "GUILD_INTEGRATIONS_UPDATE" => _guild_integrations_update(data as GuildIntegrationsUpdate)
            | "GUILD_MEMBER_ADD" => _guild_member_add(data as GuildMemberAdd)
            | "GUILD_MEMBER_REMOVE" => _guild_member_remove(data as GuildMemberRemove)
            | "GUILD_MEMBER_UPDATE" => _guild_member_update(data as GuildMemberUpdate)
            | "GUILD_MEMBERS_CHUNK" => _guild_members_chunk(data as GuildMembersChunk)
            ...
            | "GUILD_SCHEDULED_EVENT_CREATE" => _guild_scheduled_event_create(data as GuildScheduledEvent)
            | "GUILD_SCHEDULED_EVENT_UPDATE" => _guild_scheduled_event_update(data as GuildScheduledEvent)
            | "GUILD_SCHEDULED_EVENT_DELETE" => _guild_scheduled_event_delete(data as GuildScheduledEvent)
            | "GUILD_SCHEDULED_EVENT_USER_ADD" => _guild_scheduled_event_user_add(data as GuildScheduledEventUserAdd)
            | "GUILD_SCHEDULED_EVENT_USER_REMOVE" => _guild_scheduled_event_user_remove(data as GuildScheduledEventUserRemove)
            | "GUILD_SOUNDBOARD_SOUND_CREATE" => _guild_soundboard_sound_create(data as SoundboardSound)
            | "GUILD_SOUNDBOARD_SOUND_UPDATE" => _guild_soundboard_sound_update(data as SoundboardSound)
            | "GUILD_SOUNDBOARD_SOUND_DELETE" => _guild_soundboard_sound_delete(data as GuildSoundboardSoundDelete)
            | "GUILD_SOUNDBOARD_SOUNDS_UPDATE" => _guild_soundboard_sounds_update(data as GuildSoundboardSoundsUpdate)
            | "SOUNDBOARD_SOUNDS" => _soundboard_sounds(data as SoundboardSounds)
            | "INTEGRATION_CREATE" => _integration_create(data as IntegrationCreate)
            | "INTEGRATION_UPDATE" => _integration_update(data as IntegrationUpdate)
            | "INTEGRATION_DELETE" => _integration_delete(data as IntegrationDelete)
            ...
            | "MESSAGE_DELETE_BULK" => _message_delete_bulk(data as MessageDeleteBulk)
            | "MESSAGE_REACTION_ADD" => _message_reaction_add(data as MessageReactionAdd)
            | "MESSAGE_REACTION_REMOVE" => _message_reaction_remove(data as MessageReactionRemove)
            | "MESSAGE_REACTION_REMOVE_ALL" => _message_reaction_remove_all(data as MessageReactionRemoveAll)
            | "MESSAGE_REACTION_REMOVE_EMOJI" => _message_reaction_remove_emoji(data as MessageReactionRemoveEmoji)
            | "MESSAGE_POLL_VOTE_ADD" => _message_poll_vote_add(data as MessagePollVoteAdd)
            | "MESSAGE_POLL_VOTE_REMOVE" => _message_poll_vote_remove(data as MessagePollVoteRemove)
            | "PRESENCE_UPDATE" => _presence_update(data as Presence)
            | "STAGE_INSTANCE_CREATE" => _stage_instance_create(data as StageInstance)
            | "STAGE_INSTANCE_UPDATE" => _stage_instance_update(data as StageInstance)
            | "STAGE_INSTANCE_DELETE" => _stage_instance_delete(data as StageInstance)
            | "SUBSCRIPTION_CREATE" => _subscription_create(data as Subscription)
            | "SUBSCRIPTION_UPDATE" => _subscription_update(data as Subscription)
            | "SUBSCRIPTION_DELETE" => _subscription_delete(data as Subscription)
            | "TYPING_START" => _typing_start(data as TypingStart)
            | "USER_UPDATE" => _user_update(data as User)
            | "VOICE_CHANNEL_EFFECT_SEND" => _voice_channel_effect_send(data as VoiceChannelEffectSend)
            | "VOICE_CHANNEL_STATUS_UPDATE" => _voice_channel_status_update(data as VoiceChannelStatusUpdate)
            | "VOICE_CHANNEL_START_TIME_UPDATE" => _voice_channel_start_time_update(data as VoiceChannelStartTimeUpdate)
