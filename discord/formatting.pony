...
primitive Formatting
    ...
    fun user(id: data.Snowflake): String =>
        ...
        of the allowed_mentions field when creating a message.
    ...
    fun guild_navigation(
        id: data.Snowflake,
        type': GuildNavigationType val
    ): String => "<" + id.string() + ":" + type'.value() + ">"
...
class GuildNavigationTypeLinkedRolesWithId is GuildNavigationType
    """
    Specific linked role, opening the connection modal on click (the second id
    is the role id)
    """
