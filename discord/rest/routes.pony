...
actor Routes
    ...
    be get_application_role_connection_metadata(
        application_id: Snowflake,
        handler: ResponseHandler[Array[ApplicationRoleConnectionMetadata] val]
    ) =>
        """
        ...
        api.send_request(
            ...
            _Decode.list[ApplicationRoleConnectionMetadata](
                handler, options.on_error
            )
        )

    be update_application_role_connection_metadata(
        application_id: Snowflake,
        application_role_connection_metadata: Array[
        ...
        for record in application_role_connection_metadata.values() do
            records = records.push(record.to_json())
        end
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/applications/" + application_id.string()
                + "/role-connections/metadata" where body =
                    json.JsonPrinter.print(records)
            ),
            _Decode.list[ApplicationRoleConnectionMetadata](
                handler, options.on_error
            )
    ...
    be get_application(handler: ResponseHandler[Application]) =>
        ...
        api.send_request(
            options.build_request(courier.GET, "/applications/@me"),
            _Decode.entity[Application](handler, options.on_error)
        )

    be update_application(
        params: UpdateApplicationParams,
        handler: ResponseHandler[Application]
    ) =>
        """
        https://docs.discord.com/developers/resources/application#edit-current-application

        Edit properties of the app associated with the requesting bot user. Only
        properties that are passed will be updated. Returns the updated
        application object on success.
        """

        api.send_request(
            options.build_request(
                courier.PATCH,
                "/applications/@me" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[Application](handler, options.on_error)
        )

    be get_application_activity_instance(
        application_id: Snowflake,
        activity_instance_id: Snowflake,
        handler: ResponseHandler[ActivityInstance]
    ) =>
        """
        https://docs.discord.com/developers/resources/application#get-application-activity-instance

        Returns a serialized activity instance, if it exists. Useful for
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string()
                + "/activity-instances/" + activity_instance_id.string()
            ),
            _Decode.entity[ActivityInstance](handler, options.on_error)
        )

    be get_audit_log(
        guild_id: Snowflake,
        params: GetAuditLogParams,
        handler: ResponseHandler[AuditLog]
    ) =>
        """
        ...
        The returned list of audit log entries is ordered based on whether you
        use before or after. When using before, the list is ordered by the audit
        log entry ID descending (newer entries first). If after is used, the
        list is reversed and appears in ascending order (older entries first).
        Omitting both before and after defaults to before the current timestamp
        and will show the most recent entries in descending order by ID, the
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/audit-logs" where query =
                    params.to_query()
            ),
            _Decode.entity[AuditLog](handler, options.on_error)
        )

    be get_auto_moderation_rules(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[AutoModerationRule] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/auto-moderation#list-auto-moderation-rules-for-guild

        Get a list of all rules currently configured for the guild. Returns a
        list of auto moderation rule objects for the given guild.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/auto-moderation/rules"
            ),
            _Decode.list[AutoModerationRule](handler, options.on_error)
        )

    be get_auto_moderation_rule(
        guild_id: Snowflake,
        auto_moderation_rule_id: Snowflake,
        handler: ResponseHandler[AutoModerationRule]
    ) =>
        """
        ...
        api.send_request(
            ...
            _Decode.entity[AutoModerationRule](handler, options.on_error)
        )

    be create_auto_moderation_rule(
        guild_id: Snowflake,
        ...
        Create a new rule. Returns an auto moderation rule on success. Fires an
        Auto Moderation Rule Create Gateway event.
        """
        ...
        api.send_request(
            options.build_request(
                ...
                + "/auto-moderation/rules" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[AutoModerationRule](handler, options.on_error)
    ...
    be update_auto_moderation_rule(
        guild_id: Snowflake,
        auto_moderation_rule_id: Snowflake,
        params: UpdateAutoModerationRuleParams,
        handler: ResponseHandler[AutoModerationRule],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/auto-moderation/rules/"
                + auto_moderation_rule_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[AutoModerationRule](handler, options.on_error)
    ...
    be delete_auto_moderation_rule(
        guild_id: Snowflake,
        auto_moderation_rule_id: Snowflake,
        ...
        Delete a rule. Returns a 204 on success. Fires an Auto Moderation Rule
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/auto-moderation/rules/"
                + auto_moderation_rule_id.string() where reason =
                    reason
            ),
    ...
    be get_channel(channel_id: Snowflake, handler: ResponseHandler[Channel]) =>
        ...
        Get a channel by ID. Returns a channel object. If the channel is a
        thread, a thread member object is included in the returned result.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/channels/" + channel_id.string()
            ),
    ...
    be update_channel(
        ...
        REQUEST on invalid parameters.
        """

        api.send_request(
            options.build_request(
                courier.PATCH,
                "/channels/" + channel_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Channel](handler, options.on_error)
    ...
    be set_voice_channel_status(
        channel_id: Snowflake,
        params: SetVoiceChannelStatusParams,
        handler: EmptyResponseHandler,
        reason: (Reason | None) = None
    ) =>
        """
        ...
        permission, and additionally the MANAGE_CHANNELS permission if the
        current user is not connected to the voice channel. Fires a Voice
    ...
    be delete_channel(
        ...
        MANAGE_CHANNELS permission for the guild, or MANAGE_THREADS if the
        channel is a thread. Deleting a category does not delete its child
        channels; they will have their parent_id removed and a Channel Update
        Gateway event will fire for each of them. Returns a channel object on
        success. Fires a Channel Delete Gateway event (or Thread Delete if the
        channel was a thread).
        """

        api.send_request(
            options.build_request(
                courier.DELETE,
                "/channels/" + channel_id.string() where reason = reason
            ),
            _Decode.entity[Channel](handler, options.on_error)
        )

    be update_channel_permissions(
        channel_id: Snowflake,
        permission_overwrite_id: Snowflake,
        ...
        overwrite in the channel). Returns a 204 empty response on success.
        Fires a Channel Update Gateway event. For more information about
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/permissions/"
                + permission_overwrite_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.empty(handler, options.on_error)
    ...
    be get_channel_invites(
        channel_id: Snowflake,
        handler: ResponseHandler[Array[Invite] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/channels/" + channel_id.string() + "/invites"
            ),
            _Decode.list[Invite](handler, options.on_error)
        )

    be create_channel_invite(
        channel_id: Snowflake,
        params: CreateChannelInviteParams,
        handler: ResponseHandler[Invite],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/channels/" + channel_id.string() + "/invites" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
    ...
    be delete_channel_permission_overwrite(
        channel_id: Snowflake,
        permission_overwrite_id: Snowflake,
        handler: EmptyResponseHandler,
        reason: (Reason | None) = None
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/channels/" + channel_id.string() + "/permissions/"
                + permission_overwrite_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be follow_announcement_channel(
        channel_id: Snowflake,
        params: FollowAnnouncementChannelParams,
        handler: ResponseHandler[FollowedChannel],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/channels/" + channel_id.string() + "/followers" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[FollowedChannel](handler, options.on_error)
        )

    be trigger_typing_indicator(
        channel_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        Post a typing indicator for the specified channel, which expires after
        10 seconds. Returns a 204 empty response on success. Fires a Typing
        Start Gateway event.

        Generally bots should not use this route. However, if a bot is
        ...
        api.send_request(
            options.build_request(
                courier.POST, "/channels/" + channel_id.string() + "/typing"
            ),
            _Decode.empty(handler, options.on_error)
        )

    be add_group_dm_recipient(
        channel_id: Snowflake,
        user_id: Snowflake,
        params: AddGroupDMRecipientParams,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/recipients/"
                + user_id.string() where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.empty(handler, options.on_error)
        )

    be remove_group_dm_recipient(
        channel_id: Snowflake,
        user_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
    ...
    be start_thread_from_message(
        channel_id: Snowflake,
        message_id: Snowflake,
        params: StartThreadFromMessageParams,
        handler: ResponseHandler[Channel],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        When called on a GUILD_TEXT channel, creates a PUBLIC_THREAD. When
        called on a GUILD_ANNOUNCEMENT channel, creates a ANNOUNCEMENT_THREAD.
        Does not work on a GUILD_FORUM or a GUILD_MEDIA channel. The id of the
        created thread will be the same as the id of the source message, and as
        such a message can only have a single thread created from it.
        """
        ...
        api.send_request(
            options.build_request(
                ...
                + message_id.string() + "/threads" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Channel](handler, options.on_error)
    ...
    be start_thread_without_message(
        channel_id: Snowflake,
        params: StartThreadWithoutMessageParams,
        handler: ResponseHandler[Channel],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Returns a channel on success, and a 400 BAD REQUEST on invalid
    ...
    be start_thread_in_forum_or_media_channel(
        channel_id: Snowflake,
    ...
    be join_thread(channel_id: Snowflake, handler: EmptyResponseHandler) =>
        ...
        archived. Returns a 204 empty response on success. Fires a Thread
        Members Update and a Thread Create Gateway event.
        """

        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/thread-members/@me"
            ),
            _Decode.empty(handler, options.on_error)
        )

    be add_thread_member(
        channel_id: Snowflake,
        user_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        Adds another member to a thread. Requires the ability to send messages
        in the thread. Also requires the thread is not archived. Returns a 204
        empty response if the member is successfully added or was already a
        member of the thread. Fires a Thread Members Update Gateway event.
        """

        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/thread-members/"
                + user_id.string()
            ),
            _Decode.empty(handler, options.on_error)
        )
    ...
    be get_thread_member(
        channel_id: Snowflake,
        user_id: Snowflake,
        params: GetThreadMemberParams,
        handler: ResponseHandler[ThreadMember]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string() + "/thread-members/"
                + user_id.string() where query =
                    params.to_query()
            ),
            _Decode.entity[ThreadMember](handler, options.on_error)
        )

    be get_thread_members(
        channel_id: Snowflake,
        params: GetThreadMembersParams,
        handler: ResponseHandler[Array[ThreadMember] val]
    ) =>
        """
        ...
        thread member object will include a member field containing a guild
        member object.

        This endpoint is restricted according to whether the GUILD_MEMBERS
        Privileged Intent is enabled for your application. Without it Discord
        answers 403 Missing Access, even for a thread the bot is itself a member
        of.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string()
                + "/thread-members" where query =
                    params.to_query()
            ),
            _Decode.list[ThreadMember](handler, options.on_error)
        )

    be get_public_archived_threads(
        channel_id: Snowflake,
        params: GetPublicArchivedThreadsParams,
        handler: ResponseHandler[ArchivedThreads]
    ) =>
        """
        https://docs.discord.com/developers/resources/channel#list-public-archived-threads

        Returns archived threads in the channel that are public. When called on
        a GUILD_TEXT channel, returns threads of type PUBLIC_THREAD. When called
        on a GUILD_ANNOUNCEMENT channel returns threads of type
        ANNOUNCEMENT_THREAD. Threads are ordered by archive_timestamp, in
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string()
                + "/threads/archived/public" where query =
                    params.to_query()
            ),
            _Decode.entity[ArchivedThreads](handler, options.on_error)
        )

    be get_private_archived_threads(
        channel_id: Snowflake,
        params: GetPrivateArchivedThreadsParams,
        handler: ResponseHandler[ArchivedThreads]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string()
                + "/threads/archived/private" where query =
                    params.to_query()
            ),
            _Decode.entity[ArchivedThreads](handler, options.on_error)
        )

    be get_joined_private_archived_threads(
        channel_id: Snowflake,
        params: GetJoinedPrivateArchivedThreadsParams,
        handler: ResponseHandler[ArchivedThreads]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string()
                + "/users/@me/threads/archived/private" where query =
                    params.to_query()
            ),
            _Decode.entity[ArchivedThreads](handler, options.on_error)
        )
    ...
    be get_guild_emojis(
        ...
        Returns a list of emoji objects for the given guild. Includes user
        fields if the bot has the CREATE_GUILD_EXPRESSIONS or
        MANAGE_GUILD_EXPRESSIONS permission.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/emojis"
            ),
            _Decode.list[Emoji](handler, options.on_error)
        )

    be get_guild_emoji(
        guild_id: Snowflake,
        emoji_id: Snowflake,
        handler: ResponseHandler[Emoji]
    ) =>
        """
        https://docs.discord.com/developers/resources/emoji#get-guild-emoji

        Returns an emoji object for the given guild and emoji IDs. Includes the
        user field if the bot has the MANAGE_GUILD_EXPRESSIONS permission, or if
        the bot created the emoji and has the CREATE_GUILD_EXPRESSIONS
        permission.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/emojis/" + emoji_id.string()
            ),
            _Decode.entity[Emoji](handler, options.on_error)
        )

    be create_guild_emoji(
        guild_id: Snowflake,
        ...
        Create a new emoji for the guild. Requires the CREATE_GUILD_EXPRESSIONS
        permission. Returns the new emoji object on success. Fires a Guild
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/emojis" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Emoji](handler, options.on_error)
    ...
    be update_guild_emoji(
        guild_id: Snowflake,
        emoji_id: Snowflake,
        params: UpdateGuildEmojiParams,
        handler: ResponseHandler[Emoji],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Modify the given emoji. For emojis created by the current user, requires
        either the CREATE_GUILD_EXPRESSIONS or MANAGE_GUILD_EXPRESSIONS
        permission. For other emojis, requires the MANAGE_GUILD_EXPRESSIONS
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/emojis/"
                + emoji_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Emoji](handler, options.on_error)
    ...
    be delete_guild_emoji(
        ...
        Delete the given emoji. For emojis created by the current user, requires
        either the CREATE_GUILD_EXPRESSIONS or MANAGE_GUILD_EXPRESSIONS
        permission. For other emojis, requires the MANAGE_GUILD_EXPRESSIONS
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/emojis/"
                + emoji_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be get_application_emojis(
        application_id: Snowflake,
        handler: ResponseHandler[Array[Emoji] val]
    ) =>
        """
        ...
        Returns an object containing a list of emoji objects for the given
        application under the items key. Includes a user object for the team
        member that uploaded the emoji from the app’s settings, or for the bot
        user if uploaded using the API.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/emojis"
            ),
            _Decode.wrapped[Emoji](handler, "items", options.on_error)
        )

    be get_application_emoji(
        application_id: Snowflake,
        emoji_id: Snowflake,
        handler: ResponseHandler[Emoji]
    ) =>
    ...
    be create_application_emoji(
        ...
        Create a new emoji for the application. Returns the new emoji object on
        success.
        """
    ...
    be get_entitlements(
        ...
        handler: ResponseHandler[Array[Entitlement] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string()
                + "/entitlements" where query =
                    params.to_query()
            ),
            _Decode.list[Entitlement](handler, options.on_error)
        )

    be get_entitlement(
        application_id: Snowflake,
        entitlement_id: Snowflake,
        handler: ResponseHandler[Entitlement]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/entitlements/"
                + entitlement_id.string()
            ),
            _Decode.entity[Entitlement](handler, options.on_error)
        )

    be consume_entitlement(
        application_id: Snowflake,
        entitlement_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        user as consumed. The entitlement will have consumed: true when using
        List Entitlements.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/applications/" + application_id.string() + "/entitlements/"
                + entitlement_id.string() + "/consume"
            ),
            _Decode.empty(handler, options.on_error)
        )

    be create_test_entitlement(
        application_id: Snowflake,
        ...
        This endpoint returns a partial entitlement object. It will not contain
        subscription_id, starts_at, or ends_at, as it's valid in perpetuity.

        After creating a test entitlement, you'll need to reload your Discord
        client. After doing so, you'll see that your server or user now has
        premium access.
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/applications/" + application_id.string()
                + "/entitlements" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[Entitlement](handler, options.on_error)
        )

    be delete_test_entitlement(
        application_id: Snowflake,
        entitlement_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        that user or guild _no longer has_ entitlement to your premium offering.
    ...
    be get_guild(
        ...
        handler: ResponseHandler[Guild]
    ) =>
        """
        https://docs.discord.com/developers/resources/guild#get-guild

        Returns the guild object for the given id. If with_counts is set to
        true, this endpoint will also return approximate_member_count and
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() where query = params.to_query()
            ),
            _Decode.entity[Guild](handler, options.on_error)
        )

    be get_guild_preview(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildPreview]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/preview"
            ),
            _Decode.entity[GuildPreview](handler, options.on_error)
        )
    ...
    be update_guild(
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Guild](handler, options.on_error)
    ...
    be get_guild_channels(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Channel] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/channels"
            ),
            _Decode.list[Channel](handler, options.on_error)
        )

    be create_guild_channel(
        guild_id: Snowflake,
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/channels" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Channel](handler, options.on_error)
    ...
    be update_guild_channel_positions(
        guild_id: Snowflake,
        params: UpdateGuildChannelPositionsParams,
        handler: EmptyResponseHandler
    ) =>
        """
    ...
    be get_active_guild_threads(
        guild_id: Snowflake,
        handler: ResponseHandler[ActiveThreads]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/threads/active"
            ),
            _Decode.entity[ActiveThreads](handler, options.on_error)
        )

    be get_guild_member(
        guild_id: Snowflake,
        user_id: Snowflake,
        handler: ResponseHandler[GuildMember]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/members/" + user_id.string()
            ),
            _Decode.entity[GuildMember](handler, options.on_error)
        )

    be get_guild_members(
        guild_id: Snowflake,
        params: GetGuildMembersParams,
        handler: ResponseHandler[Array[GuildMember] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/members" where query =
                    params.to_query()
            ),
            _Decode.list[GuildMember](handler, options.on_error)
        )

    be search_guild_members(
        guild_id: Snowflake,
    ...
    be add_guild_member(
        ...
        to adding new members as pending in the guild member object. Members
        that are pending will have to complete membership screening before they
        become full members that can talk.
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/guilds/" + guild_id.string() + "/members/"
                + user_id.string() where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[GuildMember](handler, options.on_error)
    ...
    be update_guild_member(
        ...
        members to channels, the API user _must_ have permissions to both
        connect to the channel and have the MOVE_MEMBERS permission.
    ...
    be update_current_member(
        guild_id: Snowflake,
        params: UpdateCurrentMemberParams,
        handler: ResponseHandler[GuildMember],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/members/@me" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildMember](handler, options.on_error)
    ...
    be update_current_user_nick(
        guild_id: Snowflake,
        params: UpdateCurrentUserNickParams,
        handler: ResponseHandler[CurrentUserNick],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Modifies the nickname of the current user in a guild. Returns a 200 with
        the nickname on success. Fires a Guild Member Update Gateway event.
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string()
                + "/members/@me/nick" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[CurrentUserNick](handler, options.on_error)
        )

    be add_guild_member_role(
        guild_id: Snowflake,
        user_id: Snowflake,
        role_id: Snowflake,
        handler: EmptyResponseHandler,
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/guilds/" + guild_id.string() + "/members/" + user_id.string()
                + "/roles/" + role_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be remove_guild_member_role(
        guild_id: Snowflake,
        user_id: Snowflake,
        role_id: Snowflake,
        handler: EmptyResponseHandler,
        ...
        permission. Returns a 204 empty response on success. Fires a Guild
    ...
    be remove_guild_member(
        ...
        Remove a member from a guild. Requires KICK_MEMBERS permission. Returns
        a 204 empty response on success. Fires a Guild Member Remove Gateway
        event.
    ...
    be get_guild_bans(
        guild_id: Snowflake,
        params: GetGuildBansParams,
        handler: ResponseHandler[Array[Ban] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/bans" where query =
                    params.to_query()
            ),
            _Decode.list[Ban](handler, options.on_error)
        )

    be get_guild_ban(
        guild_id: Snowflake,
        user_id: Snowflake,
        handler: ResponseHandler[Ban]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/bans/" + user_id.string()
            ),
            _Decode.entity[Ban](handler, options.on_error)
        )
    ...
    be bulk_guild_ban(
        ...
        handler: ResponseHandler[BulkBanResponse],
        reason: (Reason | None) = None
    ) =>
        """
        https://docs.discord.com/developers/resources/guild#bulk-guild-ban

        Ban up to 200 users from a guild, and optionally delete previous
        messages sent by the banned users. Requires both the BAN_MEMBERS and
        MANAGE_GUILD permissions. Returns a 200 response on success, including
        the fields banned_users with the IDs of the banned users and
        failed_users with IDs that could not be banned or were already banned.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/bulk-ban" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[BulkBanResponse](handler, options.on_error)
        )

    be get_guild_roles(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Role] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/roles"
            ),
            _Decode.list[Role](handler, options.on_error)
        )

    be get_guild_role(
        guild_id: Snowflake,
        role_id: Snowflake,
        handler: ResponseHandler[Role]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/roles/" + role_id.string()
            ),
            _Decode.entity[Role](handler, options.on_error)
        )

    be get_guild_role_member_counts(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildRoleMemberCounts]
    ) =>
        """
        https://docs.discord.com/developers/resources/guild#get-guild-role-member-counts

        Returns a map of role IDs to the number of members with the role. Does
        not include the @everyone role.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/roles/member-counts"
            ),
            _Decode.entity[GuildRoleMemberCounts](handler, options.on_error)
        )

    be create_guild_role(
        guild_id: Snowflake,
        ...
        Returns the new role object on success. Fires a Guild Role Create
        Gateway event. All JSON params are optional.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/roles" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Role](handler, options.on_error)
    ...
    be update_guild_role_positions(
        guild_id: Snowflake,
        ...
        the MANAGE_ROLES permission. Returns a list of all of the guild's role
    ...
    be update_guild_role(
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/roles/"
                + role_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Role](handler, options.on_error)
    ...
    be delete_guild_role(
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/roles/"
                + role_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be get_guild_prune_count(
        guild_id: Snowflake,
        params: GetGuildPruneCountParams,
        handler: ResponseHandler[GuildPruneCount]
    ) =>
        """
        ...
        that would be removed in a prune operation. Requires the MANAGE_GUILD
        and KICK_MEMBERS permissions.
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/prune" where query =
                    params.to_query()
            ),
            _Decode.entity[GuildPruneCount](handler, options.on_error)
        )

    be begin_guild_prune(
        guild_id: Snowflake,
        ...
        Begin a prune operation. Requires the MANAGE_GUILD and KICK_MEMBERS
        permissions. Returns an object with one pruned key indicating the number
        of members that were removed in the prune operation. For large guilds
        it's recommended to set the compute_prune_count option to false, forcing
        pruned to null. Fires multiple Guild Member Remove Gateway events.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/prune" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildPruneCount](handler, options.on_error)
    ...
    be get_guild_voice_regions(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[VoiceRegion] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/regions"
            ),
            _Decode.list[VoiceRegion](handler, options.on_error)
        )

    be get_guild_invites(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Invite] val]
    ) =>
        """
        ...
        Returns a list of invite objects. Requires the MANAGE_GUILD or
        VIEW_AUDIT_LOG permission. Invite Metadata is included with the
        MANAGE_GUILD permission.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/invites"
            ),
            _Decode.list[Invite](handler, options.on_error)
        )

    be get_guild_integrations(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Integration] val]
    ) =>
        """
        ...
        integrations, they cannot be accessed.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/integrations"
            ),
            _Decode.list[Integration](handler, options.on_error)
        )

    be delete_guild_integration(
        guild_id: Snowflake,
        ...
        success. Fires Guild Integrations Update and Integration Delete Gateway
        events.
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/integrations/"
                + integration_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be get_guild_widget_settings(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildWidgetSettings]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/widget"
            ),
            _Decode.entity[GuildWidgetSettings](handler, options.on_error)
        )

    be update_guild_widget(
        guild_id: Snowflake,
        params: UpdateGuildWidgetParams,
        handler: ResponseHandler[GuildWidgetSettings],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        be passed in with JSON and modified. Requires the MANAGE_GUILD
        permission. Returns the updated guild widget settings object. Fires a
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/widget" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildWidgetSettings](handler, options.on_error)
    ...
    be get_guild_widget(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildWidget]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/widget.json"
            ),
            _Decode.entity[GuildWidget](handler, options.on_error)
        )

    be get_guild_vanity_url(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildVanityUrl]
    ) =>
        """
        ...
        This endpoint is required to get the usage count of the vanity invite,
        but the invite code can be accessed as vanity_url_code in the guild
        object without having the MANAGE_GUILD permission.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/vanity-url"
            ),
            _Decode.entity[GuildVanityUrl](handler, options.on_error)
        )

    be get_guild_widget_image(
        guild_id: Snowflake,
        params: GetGuildWidgetImageParams,
        handler: ResponseHandler[Array[U8] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/widget.png" where query =
                    params.to_query()
            ),
            _Decode.bytes(handler, options.on_error)
        )

    be get_guild_welcome_screen(
        guild_id: Snowflake,
        handler: ResponseHandler[WelcomeScreen]
    ) =>
        """
        https://docs.discord.com/developers/resources/guild#get-guild-welcome-screen

        Returns the Welcome Screen object for the guild. If the welcome screen
        is not enabled, the MANAGE_GUILD permission is required.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/welcome-screen"
            ),
            _Decode.entity[WelcomeScreen](handler, options.on_error)
        )

    be update_guild_welcome_screen(
        guild_id: Snowflake,
        params: UpdateGuildWelcomeScreenParams,
        handler: ResponseHandler[WelcomeScreen],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Returns the updated Welcome Screen object. May fire a Guild Update
        Gateway event.
    ...
    be get_guild_onboarding(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildOnboarding]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/onboarding"
            ),
            _Decode.entity[GuildOnboarding](handler, options.on_error)
        )

    be update_guild_onboarding(
        guild_id: Snowflake,
        params: UpdateGuildOnboardingParams,
        handler: ResponseHandler[GuildOnboarding],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Modifies the onboarding configuration of the guild. Returns a 200 with
        the Onboarding object for the guild. Requires the MANAGE_GUILD and
        MANAGE_ROLES permissions.

        Onboarding enforces constraints when enabled. These constraints are that
        there must be at least 7 Default Channels and at least 5 of them must
        allow sending messages to the @everyone role. The mode field modifies
        what is considered when enforcing these constraints.
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/guilds/" + guild_id.string() + "/onboarding" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildOnboarding](handler, options.on_error)
    ...
    be update_guild_incident_actions(
        guild_id: Snowflake,
        params: UpdateGuildIncidentActionsParams,
        handler: ResponseHandler[IncidentsData]
    ) =>
        """
        https://docs.discord.com/developers/resources/guild#modify-guild-incident-actions

        Modifies the incident actions of the guild. Returns a 200 with the
        Incidents Data object for the guild. Requires the MANAGE_GUILD
        permission.
        """
    ...
    be get_guild_scheduled_events(
        ...
        handler: ResponseHandler[Array[GuildScheduledEvent] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string()
                + "/scheduled-events" where query =
                    params.to_query()
            ),
            _Decode.list[GuildScheduledEvent](handler, options.on_error)
        )

    be create_guild_scheduled_event(
        guild_id: Snowflake,
        params: CreateGuildScheduledEventParams,
        handler: ResponseHandler[GuildScheduledEvent],
        reason: (Reason | None) = None
    ) =>
        """
        https://docs.discord.com/developers/resources/guild-scheduled-event#create-guild-scheduled-event

        Create a guild scheduled event in the guild. Returns a guild scheduled
        event object on success. Fires a Guild Scheduled Event Create Gateway
        event.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string()
                + "/scheduled-events" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildScheduledEvent](handler, options.on_error)
        )

    be get_guild_scheduled_event(
        guild_id: Snowflake,
        guild_scheduled_event_id: Snowflake,
        params: GetGuildScheduledEventParams,
        handler: ResponseHandler[GuildScheduledEvent]
    ) =>
        """
        https://docs.discord.com/developers/resources/guild-scheduled-event#get-guild-scheduled-event

        Get a guild scheduled event. Returns a guild scheduled event object on
        success.
        """
        ...
        api.send_request(
            options.build_request(
                ...
                + guild_scheduled_event_id.string() where query =
                    params.to_query()
            ),
            _Decode.entity[GuildScheduledEvent](handler, options.on_error)
        )

    be update_guild_scheduled_event(
        guild_id: Snowflake,
        guild_scheduled_event_id: Snowflake,
        params: UpdateGuildScheduledEventParams,
        handler: ResponseHandler[GuildScheduledEvent],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Modify a guild scheduled event. Returns the modified guild scheduled
        event object on success. Fires a Guild Scheduled Event Update Gateway
        event.
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string() + "/scheduled-events/"
                + guild_scheduled_event_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[GuildScheduledEvent](handler, options.on_error)
    ...
    be delete_guild_scheduled_event(
        guild_id: Snowflake,
        guild_scheduled_event_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        Delete a guild scheduled event. Returns a 204 on success. Fires a Guild
        Scheduled Event Delete Gateway event.
        """
    ...
    be get_guild_scheduled_event_users(
        guild_id: Snowflake,
        guild_scheduled_event_id: Snowflake,
        ...
        Get a list of guild scheduled event users subscribed to a guild
        scheduled event. Returns a list of guild scheduled event user objects on
        success. Guild member data, if it exists, is included if the with_member
    ...
    be get_guild_template(
        template_code: String,
        handler: ResponseHandler[GuildTemplate]
    ) =>
        """
    ...
    be get_guild_templates(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[GuildTemplate] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/templates"
            ),
            _Decode.list[GuildTemplate](handler, options.on_error)
        )

    be create_guild_template(
        guild_id: Snowflake,
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/guilds/" + guild_id.string() + "/templates" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[GuildTemplate](handler, options.on_error)
        )

    be sync_guild_template(
        guild_id: Snowflake,
        template_code: String,
        handler: ResponseHandler[GuildTemplate]
    ) =>
        ...
        MANAGE_GUILD permission. Returns the guild template object on success.
        """
    ...
    be delete_invite(
        ...
        guild. Returns an invite object on success. Fires an Invite Delete
        Gateway event.
    ...
    be get_invite_target_users(
        ...
        Gets the users allowed to see and accept this invite. Response is a CSV
        file with the header user_id and each user ID from the original file
        passed to invite create on its own line. Requires the caller to be the
        inviter, or have MANAGE_GUILD permission, or have VIEW_AUDIT_LOG
        permission.
        """
    ...
    be update_invite_target_users(
        invite_code: String,
        params: UpdateInviteTargetUsersParams,
        handler: ResponseHandler[json.JsonValue]
    ) =>
        """
        https://docs.discord.com/developers/resources/invite#update-target-users

        Updates the users allowed to see and accept this invite. Uploading a
        file with invalid user IDs will result in a 400 with the invalid IDs
        described. Requires the caller to be the inviter or have the
        MANAGE_GUILD permission.

        Discord documents no success body for this route, only the 400 it
        answers with for invalid user IDs, so the payload is handed back
        unmodelled. `get_invite_target_users_job_status` is how the asynchronous
        processing this route kicks off is followed.
        """
    ...
    be get_invite_target_users_job_status(
        invite_code: String,
        handler: ResponseHandler[TargetUsersJobStatus]
    ) =>
        """
        https://docs.discord.com/developers/resources/invite#get-target-users-job-status

        Processing target users from a CSV when creating or updating an invite
        is done asynchronously. This endpoint allows you to check the status of
        that job. Requires the caller to be the inviter, or have MANAGE_GUILD
        permission, or have VIEW_AUDIT_LOG permission.
        """
    ...
    be create_lobby(
        ...
        handler: ResponseHandler[Lobby]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#create-lobby

        Creates a new lobby, adding any of the specified members to it, if
        provided.

        Returns a lobby object.

        Discord Social SDK clients will not be able to join or leave a lobby
        created using this API, such as Client::CreateOrJoinLobby. See Managing
        Lobbies for more information.
        """
        ...
        api.send_request(
            ...
            _Decode.entity[Lobby](handler, options.on_error)
        )

    be create_or_join_lobby(
        params: CreateOrJoinLobbyParams,
        handler: ResponseHandler[Lobby]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#create-or-join-lobby

        Creates a new lobby for the application identified by a secret, or joins
        the calling user to the existing lobby with that secret if one already
        exists. Updates lobby metadata and the calling member's metadata on
        join.
    ...
    be get_lobby(lobby_id: Snowflake, handler: ResponseHandler[Lobby]) =>
        ...
        api.send_request(
            options.build_request(courier.GET, "/lobbies/" + lobby_id.string()),
            _Decode.entity[Lobby](handler, options.on_error)
        )

    be update_lobby(
        lobby_id: Snowflake,
        params: UpdateLobbyParams,
        handler: ResponseHandler[Lobby]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/lobbies/" + lobby_id.string() where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[Lobby](handler, options.on_error)
        )
    ...
    be delete_lobby(lobby_id: Snowflake, handler: EmptyResponseHandler) =>
        ...
        api.send_request(
            options.build_request(
                courier.DELETE, "/lobbies/" + lobby_id.string()
            ),
            _Decode.empty(handler, options.on_error)
        )
    ...
    be add_lobby_member(
        lobby_id: Snowflake,
        user_id: Snowflake,
        params: AddLobbyMemberParams,
        handler: ResponseHandler[LobbyMember]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#add-a-member-to-a-lobby

        Adds the provided user to the specified lobby. If called when the user
        is already a member of the lobby will update fields such as metadata on
        that user instead.
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/lobbies/" + lobby_id.string() + "/members/"
                + user_id.string() where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[LobbyMember](handler, options.on_error)
        )

    be bulk_update_lobby_members(
        lobby_id: Snowflake,
        params: BulkUpdateLobbyMembersParams,
        handler: ResponseHandler[Array[LobbyMember] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#bulk-update-lobby-members

        Adds, updates, or removes up to 25 members from the specified lobby in a
        single request. Members with remove_member: false (the default) are
        upserted — added if not present, or updated with the provided metadata
        and flags if already a member. Members with remove_member: true are
        removed.

        Returns an array of lobby member objects for the upserted members.
        Removed members are not included in the response.
        ...
        number of lobbies per application (and are not already a member of this
        lobby) are silently dropped from the upsert set.
        """

        api.send_request(
            options.build_request(
                courier.POST,
                "/lobbies/" + lobby_id.string() + "/members/bulk" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.list[LobbyMember](handler, options.on_error)
        )

    be remove_lobby_member(
        lobby_id: Snowflake,
        user_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        Removes the provided user from the specified lobby. It is safe to call
        this even if the user is no longer a member of the lobby, but will fail
    ...
    be leave_lobby(lobby_id: Snowflake, handler: EmptyResponseHandler) =>
        ...
        Removes the current user from the specified lobby. It is safe to call
        this even if the user is no longer a member of the lobby, but will fail
        if the lobby does not exist.
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/lobbies/" + lobby_id.string() + "/members/@me"
            ),
            _Decode.empty(handler, options.on_error)
        )

    be link_channel_to_lobby(
        lobby_id: Snowflake,
        params: LinkChannelToLobbyParams,
        handler: ResponseHandler[Lobby]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#link-channel-to-lobby

        Links an existing text channel to a lobby. See Linked Channels for more
        information.

        Uses Bearer token for authorization and user must be a lobby member with
        CanLinkLobby lobby member flag.
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/lobbies/" + lobby_id.string()
                + "/channel-linking" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[Lobby](handler, options.on_error)
        )

    be unlink_channel_from_lobby(
        lobby_id: Snowflake,
        handler: ResponseHandler[Lobby]
    ) =>
        """
        ...
        Send a request to this endpoint with an empty body to unlink any
        currently linked channels from the specified lobby.
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/lobbies/" + lobby_id.string() + "/channel-linking"
            ),
            _Decode.entity[Lobby](handler, options.on_error)
        )

    be send_lobby_message(
        lobby_id: Snowflake,
        params: SendLobbyMessageParams,
        handler: ResponseHandler[LobbyMessage]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#send-lobby-message

        Sends a message to the specified lobby. The calling user must be a
        member of the lobby.
        ...
        If the lobby has a linked channel, the message is also forwarded to that
        channel. If forwarding fails (for example, due to AutoMod), the lobby
        message is still delivered to other lobby members.
        """

        api.send_request(
            options.build_request(
                courier.POST,
                "/lobbies/" + lobby_id.string() + "/messages" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[LobbyMessage](handler, options.on_error)
        )

    be get_lobby_messages(
        lobby_id: Snowflake,
        params: GetLobbyMessagesParams,
        handler: ResponseHandler[Array[LobbyMessage] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#get-lobby-messages

        Returns the most recent messages in the specified lobby. The calling
        user must be a member of the lobby.

        Uses Bearer token for authorization with the sdk.social_layer scope.

        Returns an array of lobby message objects (see Send Lobby Message for
        the object shape).
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/lobbies/" + lobby_id.string() + "/messages" where query =
                    params.to_query()
            ),
            _Decode.list[LobbyMessage](handler, options.on_error)
        )

    be update_lobby_message_moderation_metadata(
        lobby_id: Snowflake,
        message_id: Snowflake,
        params: UpdateLobbyMessageModerationMetadataParams,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        app-scoped and delivered to active game clients via the Social SDK as a
        realtime message update. See Integrate Moderation for the full
        moderation flow.
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/lobbies/" + lobby_id.string() + "/messages/"
                + message_id.string() + "/moderation-metadata" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.empty(handler, options.on_error)
        )

    be create_lobby_channel_invite_for_self(
        lobby_id: Snowflake,
        handler: ResponseHandler[LobbyInvite]
    ) =>
        """
        https://docs.discord.com/developers/resources/lobby#create-lobby-channel-invite-for-self

        Creates a single-use guild invite to the lobby's linked channel,
        targeted at the calling user. The lobby must have a linked channel and
        the caller must be a member of the lobby. The invite expires after one
        hour.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/lobbies/" + lobby_id.string() + "/members/@me/invites"
            ),
            _Decode.entity[LobbyInvite](handler, options.on_error)
        )

    be create_lobby_channel_invite_for_user(
        lobby_id: Snowflake,
        user_id: Snowflake,
        handler: ResponseHandler[LobbyInvite]
    ) =>
        ...
        Creates a single-use guild invite to the lobby's linked channel on
        behalf of an application, targeted at the specified user. The lobby must
        have a linked channel. The invite expires after one hour.
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/lobbies/" + lobby_id.string() + "/members/"
                + user_id.string() + "/invites"
            ),
            _Decode.entity[LobbyInvite](handler, options.on_error)
        )

    be get_channel_messages(
        channel_id: Snowflake,
        params: GetChannelMessagesParams,
        handler: ResponseHandler[Array[Message] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/message#get-channel-messages

        Retrieves the messages in a channel. Returns an array of message objects
        from newest to oldest on success.

        If operating on a guild channel, this endpoint requires the current user
        to have the VIEW_CHANNEL permission. If the channel is a voice channel,
        they must _also_ have the CONNECT permission.

        If the current user is missing the READ_MESSAGE_HISTORY permission in
        the channel, then no messages will be returned.

        The before, after, and around parameters are mutually exclusive, only
        one may be passed at a time.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string() + "/messages" where query =
                    params.to_query()
            ),
            _Decode.list[Message](handler, options.on_error)
        )

    be search_guild_messages(
        guild_id: Snowflake,
        params: SearchGuildMessagesParams,
        handler: ResponseHandler[MessageSearchResults]
    ) =>
        """
        https://docs.discord.com/developers/resources/message#search-guild-messages

        Returns a list of messages without the reactions key that match a search
        query in the guild. Requires the READ_MESSAGE_HISTORY permission.
        ...
        return a 202 accepted response. The response body will not contain any
        search results, and will look similar to an error response:

        You should retry the request after the timeframe specified in the
        retry_after field. If the retry_after field is 0, you should retry the
        request after a short delay.

        Due to speed optimizations, search may return slightly fewer results
        than the limit specified when messages have not been accessed for a long
        time. Clients should not rely on the length of the messages array to
        paginate results.

        Additionally, when messages are actively being created or deleted, the
        total_results field may not be accurate.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string()
                + "/messages/search" where query =
                    params.to_query()
            ),
            _Decode.entity[MessageSearchResults](handler, options.on_error)
        )

    be get_channel_message(
        channel_id: Snowflake,
        message_id: Snowflake,
        ...
        channel is a voice channel, they must _also_ have the CONNECT
        permission.
        """
    ...
    be create_message(
        ...
        To create a message as a reply or forward of another message, apps can
        include a message_reference. Refer to the documentation for required
        fields.
    ...
    be crosspost_message(
        ...
        sent the message, or additionally the MANAGE_MESSAGES permission, for
        all other messages, to be present for the current user.
    ...
    be create_reaction(
        ...
        Additionally, if nobody else has reacted to the message using this
        emoji, this endpoint requires the ADD_REACTIONS permission to be present
        on the current user. Returns a 204 empty response on success. Fires a
        Message Reaction Add Gateway event. The emoji must be URL Encoded or the
        request will fail with 10014: Unknown Emoji. To use custom emoji, you
        must encode it in the format name:id with the emoji name and emoji id.
        """
    ...
    be delete_own_reaction(
        ...
        Delete a reaction the current user has made for the message. Returns a
        204 empty response on success. Fires a Message Reaction Remove Gateway
        event. The emoji must be URL Encoded or the request will fail with
        10014: Unknown Emoji. To use custom emoji, you must encode it in the
    ...
    be get_reactions(
        ...
        handler: ResponseHandler[Array[User] val]
    ) =>
        """
        ...
        user objects on success. The emoji must be URL Encoded or the request
        will fail with 10014: Unknown Emoji. To use custom emoji, you must
    ...
    be delete_all_reactions(
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/channels/" + channel_id.string() + "/messages/"
                + message_id.string() + "/reactions"
            ),
            _Decode.empty(handler, options.on_error)
        )

    be delete_all_reactions_for_emoji(
        channel_id: Snowflake,
        message_id: Snowflake,
        emoji: String,
        handler: EmptyResponseHandler
        ...
        requires the MANAGE_MESSAGES permission to be present on the current
        user. Fires a Message Reaction Remove Emoji Gateway event. The emoji
        must be URL Encoded or the request will fail with 10014: Unknown Emoji.
        To use custom emoji, you must encode it in the format name:id with the
    ...
    be update_message(
        ...
        Edit a previously sent message. The fields content, embeds, flags and
        components can be edited by the original message author. Other users can
        only edit flags and only if they have the MANAGE_MESSAGES permission in
        the corresponding channel. When specifying flags, ensure to include all
        previously set flags/bits in addition to ones that you are modifying.
        Only flags documented in the table below may be modified by users
        (unsupported flag changes are currently ignored without error).

        When the content field is edited, the arrays mentions and mention_roles
        and the boolean mention_everyone in the message object will be
        reconstructed from scratch based on the new content. When the message
        flag IS_COMPONENTS_V2 is set, the reconstructed arrays and boolean are
        based on the edited content in the components array. The
        ...
        will be parsed with _default_ allowances, that is, without regard to
        whether or not an allowed_mentions was present in the request that
        ...
        attachments that should be present after edit, including retained and
        new attachments provided in the request body.
    ...
    be delete_message(
        ...
        message that was not sent by the current user, this endpoint requires
        the MANAGE_MESSAGES permission. Returns a 204 empty response on success.
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/channels/" + channel_id.string() + "/messages/"
                + message_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be bulk_delete_messages(
        channel_id: Snowflake,
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/channels/" + channel_id.string()
                + "/messages/bulk-delete" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.empty(handler, options.on_error)
    ...
    be get_channel_pins(
        ...
        handler: ResponseHandler[ChannelPins]
    ) =>
        """
        https://docs.discord.com/developers/resources/message#get-channel-pins

        Retrieves the list of pins in a channel. Requires the VIEW_CHANNEL
        permission. If the user is missing the READ_MESSAGE_HISTORY permission
        in the channel, then no pins will be returned.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string()
                + "/messages/pins" where query =
                    params.to_query()
            ),
            _Decode.entity[ChannelPins](handler, options.on_error)
        )
    ...
    be pin_message(
        ...
        Pin a message in a channel. Requires the PIN_MESSAGES permission. Fires
        a Channel Pins Update Gateway event.
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/messages/pins/"
                + message_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
    ...
    be unpin_message(
        ...
        Unpin a message in a channel. Requires the PIN_MESSAGES permission.
    ...
    be get_pinned_messages_deprecated(
        channel_id: Snowflake,
        handler: ResponseHandler[Array[Message] val]
    ) =>
        """
        ...
        Gets the first 50 pinned messages in a channel, returning an array of
        message objects on success. This endpoint is deprecated. Use Get Channel
        Pins instead.
        """

        api.send_request(
            options.build_request(
                courier.GET, "/channels/" + channel_id.string() + "/pins"
            ),
            _Decode.list[Message](handler, options.on_error)
        )

    be pin_message_deprecated(
        channel_id: Snowflake,
        message_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/channels/" + channel_id.string() + "/pins/"
                + message_id.string()
            ),
            _Decode.empty(handler, options.on_error)
        )

    be unpin_message_deprecated(
        channel_id: Snowflake,
        message_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
    ...
    be get_answer_voters(
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/channels/" + channel_id.string() + "/polls/"
                + message_id.string() + "/answers/"
                + answer_id.string() where query =
                    params.to_query()
            ),
            _Decode.wrapped[User](handler, "users", options.on_error)
        )
    ...
    be get_skus(
        application_id: Snowflake,
        handler: ResponseHandler[Array[SKU] val]
    ) =>
        """
        ...
        Because of how our SKU and subscription systems work, you will see two
        SKUs for your subscription offering. For integration and testing
        entitlements for Subscriptions, you should use the SKU with type: 5.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/skus"
            ),
            _Decode.list[SKU](handler, options.on_error)
        )

    be send_soundboard_sound(
        channel_id: Snowflake,
        ...
        having a voice state without deaf, self_deaf, mute, or suppress enabled.
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/channels/" + channel_id.string()
                + "/send-soundboard-sound" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.empty(handler, options.on_error)
        )

    be get_default_soundboard_sounds(
        handler: ResponseHandler[Array[SoundboardSound] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/soundboard#list-default-soundboard-sounds

        Returns an array of soundboard sound objects that can be used by all
        users.
        """

        api.send_request(
            options.build_request(courier.GET, "/soundboard-default-sounds"),
            _Decode.list[SoundboardSound](handler, options.on_error)
        )

    be get_guild_soundboard_sounds(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[SoundboardSound] val]
    ) =>
        """
        ...
        Returns a list of the guild's soundboard sounds. Includes user fields if
        the bot has the CREATE_GUILD_EXPRESSIONS or MANAGE_GUILD_EXPRESSIONS
        permission.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/soundboard-sounds"
            ),
            _Decode.wrapped[SoundboardSound](handler, "items", options.on_error)
        )

    be get_guild_soundboard_sound(
        guild_id: Snowflake,
        sound_id: Snowflake,
        handler: ResponseHandler[SoundboardSound]
    ) =>
        """
        https://docs.discord.com/developers/resources/soundboard#get-guild-soundboard-sound

        Returns a soundboard sound object for the given sound id. Includes the
        user field if the bot has the CREATE_GUILD_EXPRESSIONS or
        MANAGE_GUILD_EXPRESSIONS permission.
        """
        ...
        api.send_request(
            ...
            _Decode.entity[SoundboardSound](handler, options.on_error)
        )

    be create_guild_soundboard_sound(
        guild_id: Snowflake,
        ...
        Create a new soundboard sound for the guild. Requires the
        CREATE_GUILD_EXPRESSIONS permission. Returns the new soundboard sound
        object on success. Fires a Guild Soundboard Sound Create Gateway event.

        Soundboard sounds have a max file size of 512kb and a max duration of
        5.2 seconds.
    ...
    be update_guild_soundboard_sound(
        guild_id: Snowflake,
        sound_id: Snowflake,
        ...
        Modify the given soundboard sound. For sounds created by the current
        user, requires either the CREATE_GUILD_EXPRESSIONS or
        MANAGE_GUILD_EXPRESSIONS permission. For other sounds, requires the
        MANAGE_GUILD_EXPRESSIONS permission. Returns the updated soundboard
        sound object on success. Fires a Guild Soundboard Sound Update Gateway
        event.
    ...
    be delete_guild_soundboard_sound(
        guild_id: Snowflake,
        sound_id: Snowflake,
        handler: EmptyResponseHandler,
        reason: (Reason | None) = None
        ...
        Delete the given soundboard sound. For sounds created by the current
        user, requires either the CREATE_GUILD_EXPRESSIONS or
        MANAGE_GUILD_EXPRESSIONS permission. For other sounds, requires the
        MANAGE_GUILD_EXPRESSIONS permission. Returns 204 No Content on success.
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/soundboard-sounds/"
                + sound_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be create_stage_instance(
        params: CreateStageInstanceParams,
        handler: ResponseHandler[StageInstance],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/stage-instances" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[StageInstance](handler, options.on_error)
        )

    be get_stage_instance(
        channel_id: Snowflake,
        handler: ResponseHandler[StageInstance]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/stage-instances/" + channel_id.string()
            ),
            _Decode.entity[StageInstance](handler, options.on_error)
        )

    be update_stage_instance(
        channel_id: Snowflake,
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/stage-instances/" + channel_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[StageInstance](handler, options.on_error)
    ...
    be delete_stage_instance(
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/stage-instances/" + channel_id.string() where reason = reason
            ),
            _Decode.empty(handler, options.on_error)
        )
    ...
    be get_sticker(sticker_id: Snowflake, handler: ResponseHandler[Sticker]) =>
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/stickers/" + sticker_id.string()
            ),
    ...
    be get_sticker_packs(handler: ResponseHandler[Array[StickerPack] val]) =>
        ...
        api.send_request(
            options.build_request(courier.GET, "/sticker-packs"),
            _Decode.wrapped[StickerPack](
                handler, "sticker_packs", options.on_error
            )
        )

    be get_sticker_pack(
        sticker_pack_id: Snowflake,
        handler: ResponseHandler[StickerPack]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/sticker-packs/" + sticker_pack_id.string()
            ),
            _Decode.entity[StickerPack](handler, options.on_error)
        )

    be get_guild_stickers(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Sticker] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/stickers"
            ),
            _Decode.list[Sticker](handler, options.on_error)
        )

    be get_guild_sticker(
        guild_id: Snowflake,
        ...
        Returns a sticker object for the given guild and sticker IDs. Includes
        the user field if the bot has the CREATE_GUILD_EXPRESSIONS or
        MANAGE_GUILD_EXPRESSIONS permission.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/stickers/"
                + sticker_id.string()
            ),
            _Decode.entity[Sticker](handler, options.on_error)
        )
    ...
    be create_guild_sticker(
        ...
        Requires the CREATE_GUILD_EXPRESSIONS permission. Returns the new
        sticker object on success. Fires a Guild Stickers Update Gateway event.

        Every guilds has five free sticker slots by default, and each Boost
        level will grant access to more slots.
    ...
    be update_guild_sticker(
        guild_id: Snowflake,
        sticker_id: Snowflake,
        params: UpdateGuildStickerParams,
        handler: ResponseHandler[Sticker],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        Modify the given sticker. For stickers created by the current user,
        requires either the CREATE_GUILD_EXPRESSIONS or MANAGE_GUILD_EXPRESSIONS
        permission. For other stickers, requires the MANAGE_GUILD_EXPRESSIONS
    ...
    be delete_guild_sticker(
        ...
        Delete the given sticker. For stickers created by the current user,
        requires either the CREATE_GUILD_EXPRESSIONS or MANAGE_GUILD_EXPRESSIONS
        permission. For other stickers, requires the MANAGE_GUILD_EXPRESSIONS
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/guilds/" + guild_id.string() + "/stickers/"
                + sticker_id.string() where reason =
                    reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be get_sku_subscriptions(
        sku_id: Snowflake,
        params: GetSKUSubscriptionsParams,
        handler: ResponseHandler[Array[Subscription] val]
    ) =>
        """
        https://docs.discord.com/developers/resources/subscription#list-sku-subscriptions

        Returns all subscriptions containing the SKU, filtered by user. Returns
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/skus/" + sku_id.string() + "/subscriptions" where query =
                    params.to_query()
            ),
            _Decode.list[Subscription](handler, options.on_error)
        )

    be get_sku_subscription(
        sku_id: Snowflake,
        subscription_id: Snowflake,
        handler: ResponseHandler[Subscription]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/skus/" + sku_id.string() + "/subscriptions/"
                + subscription_id.string()
            ),
            _Decode.entity[Subscription](handler, options.on_error)
        )
    ...
    be get_current_user(handler: ResponseHandler[User]) =>
        ...
        requires the identify scope, which will return the object _without_ an
        email, and optionally the email scope, which returns the object _with_
        an email if the user has one.
        """

        api.send_request(
            options.build_request(courier.GET, "/users/@me"),
            _Decode.entity[User](handler, options.on_error)
        )
    ...
    be get_user(user_id: Snowflake, handler: ResponseHandler[User]) =>
        ...
        api.send_request(
            options.build_request(courier.GET, "/users/" + user_id.string()),
            _Decode.entity[User](handler, options.on_error)
        )

    be update_current_user(
        params: UpdateCurrentUserParams,
        handler: ResponseHandler[User]
    ) =>
        """
    ...
    be get_current_user_guilds(
        params: GetCurrentUserGuildsParams,
        handler: ResponseHandler[Array[PartialGuild] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/users/@me/guilds" where query = params.to_query()
            ),
            _Decode.list[PartialGuild](handler, options.on_error)
        )

    be get_current_user_guild_member(
        guild_id: Snowflake,
        handler: ResponseHandler[GuildMember]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/users/@me/guilds/" + guild_id.string() + "/member"
            ),
            _Decode.entity[GuildMember](handler, options.on_error)
        )
    ...
    be leave_guild(guild_id: Snowflake, handler: EmptyResponseHandler) =>
        ...
        api.send_request(
            options.build_request(
                courier.DELETE, "/users/@me/guilds/" + guild_id.string()
            ),
            _Decode.empty(handler, options.on_error)
        )
    ...
    be create_dm(params: CreateDMParams, handler: ResponseHandler[Channel]) =>
        ...
        open a significant amount of DMs too quickly, your bot may be rate
        limited or blocked from opening new ones.
        """

        api.send_request(
            options.build_request(
                courier.POST,
                "/users/@me/channels" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[Channel](handler, options.on_error)
        )
    ...
    be get_current_user_connections(
        handler: ResponseHandler[Array[Connection] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(courier.GET, "/users/@me/connections"),
            _Decode.list[Connection](handler, options.on_error)
        )

    be get_current_user_application_role_connection(
        application_id: Snowflake,
        handler: ResponseHandler[ApplicationRoleConnection]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/users/@me/applications/" + application_id.string()
                + "/role-connection"
            ),
            _Decode.entity[ApplicationRoleConnection](handler, options.on_error)
        )

    be update_current_user_application_role_connection(
        application_id: Snowflake,
        ...
        Requires an OAuth2 access token with role_connections.write scope for
        the application specified in the path.
        """
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/users/@me/applications/" + application_id.string()
                + "/role-connection" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[ApplicationRoleConnection](handler, options.on_error)
        )

    be delete_current_user_application_role_connection(
        application_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        Deletes the application role connection for the user. Requires an OAuth2
        access token with role_connections.write scope for the application
        specified in the path.
        """
    ...
    be get_voice_regions(handler: ResponseHandler[Array[VoiceRegion] val]) =>
        ...
        api.send_request(
            options.build_request(courier.GET, "/voice/regions"),
            _Decode.list[VoiceRegion](handler, options.on_error)
        )

    be get_current_user_voice_state(
        guild_id: Snowflake,
        handler: ResponseHandler[VoiceState]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/voice-states/@me"
            ),
            _Decode.entity[VoiceState](handler, options.on_error)
        )

    be get_user_voice_state(
        guild_id: Snowflake,
        user_id: Snowflake,
        handler: ResponseHandler[VoiceState]
    ) =>
        ...
        If the specified user is connected to a voice channel, the current user
        must have permission to connect to the channel.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/guilds/" + guild_id.string() + "/voice-states/"
                + user_id.string()
            ),
            _Decode.entity[VoiceState](handler, options.on_error)
        )

    be update_current_user_voice_state(
        guild_id: Snowflake,
        ...
        Updates the current user's voice state. Returns 204 No Content on
        success. Fires a Voice State Update Gateway event.
        """
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/guilds/" + guild_id.string()
                + "/voice-states/@me" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.empty(handler, options.on_error)
        )

    be update_user_voice_state(
        guild_id: Snowflake,
        user_id: Snowflake,
    ...
    be create_webhook(
        ...
        handler: ResponseHandler[Webhook],
        reason: (Reason | None) = None
    ) =>
        """
        ...
        An error will be returned if a webhook name (name) is not valid. A
        webhook name is valid if:
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/channels/" + channel_id.string() + "/webhooks" where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
    ...
    be get_channel_webhooks(
        channel_id: Snowflake,
        handler: ResponseHandler[Array[Webhook] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/channels/" + channel_id.string() + "/webhooks"
            ),
            _Decode.list[Webhook](handler, options.on_error)
        )

    be get_guild_webhooks(
        guild_id: Snowflake,
        handler: ResponseHandler[Array[Webhook] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET, "/guilds/" + guild_id.string() + "/webhooks"
            ),
            _Decode.list[Webhook](handler, options.on_error)
        )
    ...
    be get_webhook(webhook_id: Snowflake, handler: ResponseHandler[Webhook]) =>
        ...
        application making the request owns the webhook. (see:
        webhook.application_id)
        """

        api.send_request(
            options.build_request(
                courier.GET, "/webhooks/" + webhook_id.string()
            ),
            _Decode.entity[Webhook](handler, options.on_error)
        )

    be get_webhook_with_token(
    ...
    be update_webhook(
        ...
        updated webhook object on success. Fires a Webhooks Update Gateway
        event.
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/webhooks/" + webhook_id.string() where body =
                    json.JsonPrinter.print(params.to_json()),
                reason = reason
            ),
            _Decode.entity[Webhook](handler, options.on_error)
    ...
    be update_webhook_with_token(
        webhook_id: Snowflake,
        webhook_token: String,
        params: UpdateWebhookWithTokenParams,
        handler: ResponseHandler[Webhook]
    ) =>
        """
        https://docs.discord.com/developers/resources/webhook#modify-webhook-with-token

        Same as above, except this call does not require authentication, does
        not accept a channel_id parameter in the body, and does not return a
    ...
    be delete_webhook(
        ...
        api.send_request(
            options.build_request(
                courier.DELETE,
                "/webhooks/" + webhook_id.string() where reason = reason
            ),
            _Decode.empty(handler, options.on_error)
        )

    be delete_webhook_with_token(
        webhook_id: Snowflake,
        webhook_token: String,
        handler: EmptyResponseHandler
    ) =>
    ...
    be execute_webhook(
        ...
        Refer to Uploading Files for details on attachments and
        multipart/form-data requests. Returns 204 No Content;
        `execute_webhook_and_wait` is the form that waits for the message.

        Note that when sending a message, you must provide a value for at least
        one of content, embeds, components, file, or poll.
        ...
        that thread. If thread_name is provided, a thread with that name will be
    ...
    be execute_webhook_and_wait(
        ...
        Refer to Uploading Files for details on attachments and
        multipart/form-data requests. Waits for server confirmation of message
        send before response, and returns the created message.
    ...
    be execute_slack_compatible_webhook(
        webhook_id: Snowflake,
        webhook_token: String,
        params: ExecuteSlackCompatibleWebhookParams,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        Answers as soon as the message is accepted, so a message that is not
        saved does not return an error;
        `execute_slack_compatible_webhook_and_wait` is the form that waits for
        server confirmation.
        """
    ...
    be execute_slack_compatible_webhook_and_wait(
        webhook_id: Snowflake,
        webhook_token: String,
        params: ExecuteSlackCompatibleWebhookParams,
        handler: EmptyResponseHandler
        ...
        Waits for server confirmation of message send before response, so a
        message that is not saved comes back as an error.
        """
    ...
    be execute_github_compatible_webhook(
        webhook_id: Snowflake,
        webhook_token: String,
        params: ExecuteGithubCompatibleWebhookParams,
        handler: EmptyResponseHandler
    ) =>
        """
        ...
        delete, fork, issue_comment, issues, member, public, pull_request,
        pull_request_review, pull_request_review_comment, push, release, watch,
        check_run, check_suite, discussion, and discussion_comment.

        Answers as soon as the message is accepted, so a message that is not
        saved does not return an error;
        `execute_github_compatible_webhook_and_wait` is the form that waits for
        server confirmation.
        """
    ...
    be execute_github_compatible_webhook_and_wait(
        webhook_id: Snowflake,
        webhook_token: String,
        params: ExecuteGithubCompatibleWebhookParams,
        handler: EmptyResponseHandler
    ...
    be create_interaction_response(
        ...
        Returns 204; `create_interaction_response_with_response` is the form
        that returns the interaction callback response.
    ...
    be create_interaction_response_with_response(
        interaction_id: Snowflake,
        interaction_token: String,
        params: CreateInteractionResponseParams,
        ...
        Create a response to an Interaction. Body is an interaction response.
        Returns 200 with the body as interaction callback response.
    ...
    be get_original_interaction_response(
        application_id: Snowflake,
        interaction_token: String,
        params: GetOriginalInteractionResponseParams,
        handler: ResponseHandler[Message]
    ) =>
        """
    ...
    be update_original_interaction_response(
        application_id: Snowflake,
        interaction_token: String,
        ...
        Edits the initial Interaction response. Functions the same as Edit
        Webhook Message.
        """
    ...
    be delete_original_interaction_response(
        application_id: Snowflake,
        interaction_token: String,
        handler: EmptyResponseHandler
    ) =>
    ...
    be create_followup_message(
        ...
        Apps are limited to 5 followup messages per interaction if it was
        initiated from a user-installed app and isn't installed in the server
        (meaning the authorizing integration owners object only contains
        USER_INSTALL)
        ...
        interaction followups. You can use the EPHEMERAL message flag 1 << 6
        (64) to send a message that only the user can see. You can also use the
        IS_COMPONENTS_V2 message flag 1 << 15 (32768) to send a component-based
        message.

        When using this endpoint directly after responding to an interaction
        with DEFERRED_CHANNEL_MESSAGE_WITH_SOURCE, this endpoint will function
        as Edit Original Interaction Response for backwards compatibility. In
        this case, no new message will be created, and the loading message will
        be edited instead. The ephemeral flag will be ignored, and the value you
        provided in the initial defer response will be preserved, as an existing
        message's ephemeral state cannot be changed. This behavior is
        deprecated, and you should use the Edit Original Interaction Response
    ...
    be get_global_application_commands(
        application_id: Snowflake,
        params: GetGlobalApplicationCommandsParams,
        handler: ResponseHandler[Array[ApplicationCommand] val]
    ) =>
        """
        https://docs.discord.com/developers/interactions/application-commands#get-global-application-commands

        The objects returned by this endpoint may be augmented with additional
        fields if localization is active.
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string()
                + "/commands" where query =
                    params.to_query()
            ),
            _Decode.list[ApplicationCommand](handler, options.on_error)
        )

    be create_global_application_command(
        application_id: Snowflake,
        params: CreateGlobalApplicationCommandParams,
        handler: ResponseHandler[ApplicationCommand]
    ) =>
        """
        ...
        api.send_request(
            ...
            _Decode.entity[ApplicationCommand](handler, options.on_error)
        )

    be get_global_application_command(
        application_id: Snowflake,
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/commands/"
                + command_id.string()
            ),
            _Decode.entity[ApplicationCommand](handler, options.on_error)
        )

    be update_global_application_command(
        application_id: Snowflake,
        command_id: Snowflake,
        params: UpdateGlobalApplicationCommandParams,
        handler: ResponseHandler[ApplicationCommand]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.PATCH,
                "/applications/" + application_id.string() + "/commands/"
                + command_id.string() where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[ApplicationCommand](handler, options.on_error)
        )

    be delete_global_application_command(
        application_id: Snowflake,
        command_id: Snowflake,
        handler: EmptyResponseHandler
    ) =>
    ...
    be bulk_overwrite_global_application_commands(
        application_id: Snowflake,
        params: BulkOverwriteGlobalApplicationCommandsParams,
        handler: ResponseHandler[Array[ApplicationCommand] val]
    ) =>
        """
        ...
        This will overwrite all types of application commands: slash commands,
    ...
    be get_guild_application_commands(
        application_id: Snowflake,
        guild_id: Snowflake,
        params: GetGuildApplicationCommandsParams,
        handler: ResponseHandler[Array[ApplicationCommand] val]
    ) =>
        """
        ...
        guild. Returns an array of application command objects.
        """

        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/guilds/"
                + guild_id.string() + "/commands" where query =
                    params.to_query()
            ),
            _Decode.list[ApplicationCommand](handler, options.on_error)
        )

    be create_guild_application_command(
        application_id: Snowflake,
        guild_id: Snowflake,
        params: CreateGuildApplicationCommandParams,
        handler: ResponseHandler[ApplicationCommand]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.POST,
                "/applications/" + application_id.string() + "/guilds/"
                + guild_id.string() + "/commands" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.entity[ApplicationCommand](handler, options.on_error)
        )

    be get_guild_application_command(
        application_id: Snowflake,
        guild_id: Snowflake,
        command_id: Snowflake,
        handler: ResponseHandler[ApplicationCommand]
        ...
        Fetch a guild command for your application. Returns an application
        command object.
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/guilds/"
                + guild_id.string() + "/commands/" + command_id.string()
            ),
            _Decode.entity[ApplicationCommand](handler, options.on_error)
        )

    be update_guild_application_command(
        application_id: Snowflake,
        guild_id: Snowflake,
        command_id: Snowflake,
        params: UpdateGuildApplicationCommandParams,
        handler: ResponseHandler[ApplicationCommand]
    ) =>
        """
        ...
        immediately. Returns 200 and an application command object. All fields
        are optional, but any fields provided will entirely overwrite the
    ...
    be delete_guild_application_command(
        application_id: Snowflake,
        guild_id: Snowflake,
        command_id: Snowflake,
        handler: EmptyResponseHandler
    ...
    be bulk_overwrite_guild_application_commands(
        application_id: Snowflake,
        guild_id: Snowflake,
        params: BulkOverwriteGuildApplicationCommandsParams,
        handler: ResponseHandler[Array[ApplicationCommand] val]
    ) =>
        """
    ...
    be get_guild_application_command_permissions(
        application_id: Snowflake,
        guild_id: Snowflake,
        handler: ResponseHandler[Array[GuildApplicationCommandPermissions] val]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(
                courier.GET,
                "/applications/" + application_id.string() + "/guilds/"
                + guild_id.string() + "/commands/permissions"
            ),
            _Decode.list[GuildApplicationCommandPermissions](
                handler, options.on_error
            )
        )

    be get_application_command_permissions(
        application_id: Snowflake,
        guild_id: Snowflake,
        command_id: Snowflake,
        handler: ResponseHandler[GuildApplicationCommandPermissions]
    ) =>
        """
        ...
        api.send_request(
            ...
            _Decode.entity[GuildApplicationCommandPermissions](
                handler, options.on_error
            )
        )

    be update_application_command_permissions(
        application_id: Snowflake,
        guild_id: Snowflake,
        command_id: Snowflake,
        params: UpdateApplicationCommandPermissionsParams,
        handler: ResponseHandler[GuildApplicationCommandPermissions]
    ) =>
        """
        https://docs.discord.com/developers/interactions/application-commands#edit-application-command-permissions

        This endpoint will overwrite existing permissions for the command in
        that guild

        Edits command permissions for a specific command for your application in
        a guild and returns a guild application command permissions object.
        ...
        above about application command permissions.

        Deleting or renaming a command will permanently delete all permissions
        for the command
        """
    ...
    be batch_update_application_command_permissions(
        application_id: Snowflake,
        guild_id: Snowflake,
        params: BatchUpdateApplicationCommandPermissionsParams,
        handler: ResponseHandler[Array[GuildApplicationCommandPermissions] val]
    ) =>
        """
        https://docs.discord.com/developers/interactions/application-commands#batch-edit-application-command-permissions

        This endpoint has been disabled with updates to command permissions
        (Permissions v2). Instead, you can edit each application command
        permissions (though you should be careful to handle any potential rate
        limits).
        """
        ...
        api.send_request(
            options.build_request(
                courier.PUT,
                "/applications/" + application_id.string() + "/guilds/"
                + guild_id.string() + "/commands/permissions" where body =
                    json.JsonPrinter.print(params.to_json())
            ),
            _Decode.list[GuildApplicationCommandPermissions](
                handler, options.on_error
    ...
    be get_current_bot_application_information(
        handler: ResponseHandler[Application]
    ) =>
        """
        ...
        api.send_request(
            options.build_request(courier.GET, "/oauth2/applications/@me"),
            _Decode.entity[Application](handler, options.on_error)
        )

    be get_current_authorization_information(
        handler: ResponseHandler[AuthorizationInformation]
    ) =>
        """
        https://docs.discord.com/developers/topics/oauth2#get-current-authorization-information

        Returns info about the current authorization. Requires authentication
        with a bearer token.
        """

        api.send_request(
            options.build_request(courier.GET, "/oauth2/@me"),
            _Decode.entity[AuthorizationInformation](handler, options.on_error)
        )
    ...
    be get_gateway(handler: ResponseHandler[GatewayInfo]) =>
        ...
        Returns an object with a valid WSS URL which the app can use when
        Connecting to the Gateway. Apps should cache this value and only call
        this endpoint to retrieve a new URL when they are unable to properly
        establish a connection using the cached one.
        """

        api.send_request(
            options.build_request(courier.GET, "/gateway"),
            _Decode.entity[GatewayInfo](handler, options.on_error)
        )
    ...
    be get_gateway_bot(handler: ResponseHandler[GatewayBotInfo]) =>
        ...
        Returns an object based on the information in Get Gateway, plus
        additional metadata that can help during the operation of large or
        sharded bots. Unlike the Get Gateway, this route should not be cached
        for extended periods of time as the value is not guaranteed to be the
        same per-call, and changes as the bot joins/leaves guilds.
        """

        api.send_request(
            options.build_request(courier.GET, "/gateway/bot"),
            _Decode.entity[GatewayBotInfo](handler, options.on_error)
        )
...
primitive _Decode
    ...
    fun entity[A: FromJsonable val](
        handler: ResponseHandler[A],
        on_error: RestErrorHandler
    ): RawResponseHandler =>
        """
        Decodes a lone object, as returned by routes documented as returning "a
        ... object".
        """
    ...
    fun list[A: FromJsonable val](
        handler: ResponseHandler[Array[A] val],
        on_error: RestErrorHandler
    ): RawResponseHandler =>
        """
    ...
    fun wrapped[A: FromJsonable val](
        handler: ResponseHandler[Array[A] val],
        key: String,
        on_error: RestErrorHandler
    ): RawResponseHandler =>
        ...
        {(
            ...
            | let rejection: RestError => on_error(rejection)
                ...
                try
                    handler(
                        _Decode.entities[A](
                            (_Decode.parse(response)? as json.JsonObject)(key)?
                        )?
                    )
                else
                    on_error(_Decode.undecodable(request, response))
    ...
    fun entities[A: FromJsonable val](value: json.JsonValue): Array[A] val ? =>
        ...
        recover val
            ...
            for value' in array.values() do
                entities'.push(A.from_json(value' as json.JsonObject)?)
            end
            entities'
        end
    ...
    //
    // type H[A: Any val] is {(A)} val fun p(h: H[json.JsonValue]):
    // {(json.JsonValue)} val => {(v: json.JsonValue) => h(v) }
    //
    ...
    fun parse(response: courier.HTTPResponse val): json.JsonValue ? =>
        ...
        | let error': json.JsonParseError =>
            Debug.out(
                "[rest/decode] the body is not well-formed JSON: "
                + error'.string()
            )
            error
